...
def index():
    ...
    [continent_stats_header, continent_stats_body] = find_continent_stats()
    ...
    return render_template('index.html',
                           ...
                           continent_stats_header= continent_stats_header,
                           continent_stats_body= continent_stats_body,
